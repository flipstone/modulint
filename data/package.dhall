...
let perModuleDocumentationRules = DocumentationRules.PerModuleDocumentationRules

let globalModuleDocumentationRule = DocumentationRules.GlobalDocumentationRule
      ...
      , default =
        ...
        , documentationRules =
            perModuleDocumentationRules
              (toMap {=} : PerModuleDocumentationRules)
        , allowedOpenUnaliasedImports =
            AllowedOpenUnaliasedImports.PerModuleOpenUnaliasedImports
